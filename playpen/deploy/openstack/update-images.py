...
for image in pulp_images:
    ...
    setup_utils.yum_install(host_string, arguments.key_file, PULP_DEPENDENCY_LIST)
    setup_utils.install_puppet_module(host_string, arguments.key_file, PUPPET_MODULE_LIST)
